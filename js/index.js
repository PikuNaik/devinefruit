(function() {
  ...
  MESSAGES.push({
    delay: 0,
    text: "We connect to create the greatest expression of your brand"
  });

  /*MESSAGES.push({
    delay: 1200,
    text: "An art of designing to help you stand out"
  });

  MESSAGES.push({
    delay: 2200,
    text: "We are a perfect blend of creativity and strategy"
  });
